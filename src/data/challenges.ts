...
export const challenges: Challenge[] = [
  ...
  { id: "5", text: "Order a sentimentally relevant snack, treat, or flowers for Andrew's desk", basePoints: 20, type: "fixed" },
  ...
  { id: "23", text: "Convince Andrew to try your snack or the food you're eating", basePoints: 10, type: "fixed" },
];
